...
import { PresetThemes } from '@/components/preset-theme/preset-theme';
import {
  Accordion,
  AccordionContent,
  AccordionItem,
    ...
    <div className="m-4">
      <header>
        ...
        <p className="text-muted-foreground mt-2 text-sm">
          Customize how Ferrix looks and behaves. Appearance, plugins, and download builder options
          can be managed here. More settings are on the way — stay tuned!
        </p>
      </header>
      <Accordion type="single" collapsible className="w-full" defaultValue="appearance">
        ...
        <AccordionItem value="plugins">
          ...
          <AccordionContent className="flex flex-col gap-4">
            <p className="text-muted-foreground text-sm">
              Extend Ferrix with community-made integrations (sites, auth flows, post-processing,
              and more). A plugin store and developer docs are on the way.
            </p>
        ...
        <AccordionItem value="download-builder">
          ...
          <AccordionContent className="flex flex-col gap-4">
            <p className="text-muted-foreground text-sm">
              Configure how new downloads are created by default—chunk size, concurrency,
              verification strategy, user-agent, proxy profile, and automatic post-actions. Presets
              will let you switch profiles quickly.
            </p>
